...
#define WIFI_SSID 						"LM"				//	WIFI的名称 必须用2.4G的wifi不能用5G的，且不能用中文、空格
#define WIFI_PSWD 						"88888888"					//	WIFI密码
...
void ESP8266_Init(void)
{
	...
	ESP8266_Clear();
	OLED_ShowString(1,1,"ESP8266_Clear   ");
	DEBUG_LOG("0. AT - 测试MCU-8266通讯");
	while(ESP8266_SendCmd("AT\r\n", "OK"))
		delay_ms(500);
	OLED_ShowString(1,1," 0. AT                ");
	...
	while(ESP8266_SendCmd(ESP8266_WIFI_INFO, "GOT IP"))
		delay_ms(500);
	OLED_ShowString(1,1," 4. AT+CWJAP  ");
